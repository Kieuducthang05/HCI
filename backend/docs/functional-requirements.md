...
6. PDF report export.
7. Media asset upload/registration.
8. Audit logging for admin changes, soft deletes, bans, and report exports.
9. Pagination/cursor support for remaining list endpoints.
10. Rate limiting for auth, password reset, emotion logging, and AI event ingestion.
11. RBAC middleware for parent/admin/system authorization.
12. Webcam consent and raw-frame ban enforcement.
